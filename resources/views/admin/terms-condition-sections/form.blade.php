...
@section('page-title', $section->exists ? 'Edit Terms Section' : 'Add Terms Section')

@section('content')

<div class="admin-page-head">
    <div>
        <a href="{{ route('admin.terms-condition-sections.index') }}" class="admin-back-link">
            ← {{ trans('global.back_to_list') }}
        </a>

        <h2 class="admin-page-title">
            {{ $section->exists ? 'Edit' : 'Add' }} Terms Section
        </h2>
...
<form method="POST"
      action="{{ $section->exists ? route('admin.terms-condition-sections.update', $section) : route('admin.terms-condition-sections.store') }}">
    ...
    <div class="admin-form-grid">
        ...
        <div class="form-card">
            ...
            <div class="form-card-header">
                ...
                <div>
                    <p class="form-card-title">Terms Section Content</p>
                    <p class="form-card-subtitle">
                        Add title, subtitle, icon and terms content
                    </p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               placeholder="Please read these terms carefully before using our website"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               placeholder="bi bi-file-earmark-text"
                    ...
                    @else
                        <p class="field-hint">
                            Example: bi bi-file-earmark-text, bi bi-shield-check, bi bi-lock-fill
                        </p>
                    @endif
                </div>

                <div class="field-group">
                    <label class="field-label" for="termsContentEditor">
                        Content <span class="req">*</span>
                    </label>

                    <textarea name="content"
                              id="termsContentEditor"
                              rows="12"
                              required
            ...
            <div class="form-card-body">
                ...
                <div class="form-info-box">
                    <p>
                        ...
                        Published section public Terms & Conditions page par show hoga. Draft section frontend par hide rahega.
                    </p>
                </div>
    ...
    <div class="form-actions">
        ...
        <a href="{{ route('admin.terms-condition-sections.index') }}" class="btn-ghost">
            Cancel
        </a>
    </div>
...
if (typeof ClassicEditor !== 'undefined') {
    ClassicEditor
        .create(document.querySelector('#termsContentEditor'))
